...
namespace ToBuyAPI.Persistence.Services
{
	public class CategoryService : ICategoryService
	{
		...
		public async Task<IDataResult<ListItemCategory>> GetByIdAsync(string id)
		{
			DataResult<ListItemCategory> dataResult = new();
			...
			else
			{
				...
				dataResult.Result = _mapper.Map<ListItemCategory>(category);
			}
			return dataResult;
		}
		#endregion
